                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        trailing: Text(
                            "Points ${(200000 / (index + 1)).toString().substring(0, 5)}",style: const TextStyle(fontWeight: FontWeight.bold)),
                      );
                    },
                    separatorBuilder: (context, index) => const Divider(thickness: 1,color: Colors.green,indent: 10,endIndent: 10,),
                    itemCount: 12),
              ),
            )
          ],
